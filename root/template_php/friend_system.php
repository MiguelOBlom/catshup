...
if (isset($_POST['type']) && isset($_POST['user'])){
    ...
    $sql = "SELECT COUNT(id) FROM user WHERE username='$user' AND activated='1' LIMIT 1";
...
if (isset($_POST['action']) && isset($_POST['reqid']) && isset($_POST['user1'])){
    ...
    if($_POST['action'] == "accept"){
        ...
        mysqli_query($db_connection, "DELETE FROM friends WHERE id='$reqid' AND user1='$user' AND user2='$log_username' AND accepted='0' LIMIT 1");
        mysqli_close($db_connection);
        echo "reject_ok";
        exit();
    }
